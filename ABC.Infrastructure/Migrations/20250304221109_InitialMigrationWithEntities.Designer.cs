...
namespace ABC.Infrastructure.Migrations
{
    ...
    [Migration("20250304221109_InitialMigrationWithEntities")]
    partial class InitialMigrationWithEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABC.Core.Entities.PaymentDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABC.Core.Entities.PersonalDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABC.Core.Entities.Sender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABC.Core.Entities.MoneyTransfer", b =>
                {
                    ...
                    b.HasOne("ABC.Core.Entities.Receiver", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ABC.Core.Entities.Sender", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("ABC.Core.Entities.Receiver", b =>
                {
                    b.HasOne("ABC.Core.Entities.PersonalDetail", "PersonalDetails")
                        .WithMany()
